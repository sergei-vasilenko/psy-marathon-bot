    ...
    steps: [
      {
        message: [
          {
            type: "text",
            data: `Добро пожаловать на марафон! Я рада видеть тебя! Тебе предстоит пройти четыре задания-медитации. После каждого задания нажимай кнопку "Продолжить" и дождись следующего задания, оно придет через какое-то время. Если не получается пройти задание, я тебе напомню. А сейчас жми дальше`,
          },
          { type: "image", data: "start.jpg" },
          { type: "video", data: "start.mp4" },
        ],
